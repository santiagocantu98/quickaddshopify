          ...
          jQuery(function() {
  var $module = jQuery('#m-1597192134887').children('.module');
  ...
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597193222575');
  var $module = jQuery('#m-1597193222575').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
          ...
          jQuery(function() {
    var $module = jQuery('#m-1597193241214').children('.module');
