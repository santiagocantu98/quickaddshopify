...
(function( jQuery ){
  var $hero = jQuery('#m-1621276492974');
  var $module = jQuery('#m-1621276492974').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1621276499360').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child1').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child1-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child1-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child1-2').children('.module');
            $module.gfV3ProductPrice();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child2').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child2-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child2-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child2-2').children('.module');
            $module.gfV3ProductPrice();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child3').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child3-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child3-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child3-2').children('.module');
            $module.gfV3ProductPrice();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child4').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child4-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child4-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child4-2').children('.module');
            $module.gfV3ProductPrice();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child5').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child5-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child5-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child5-2').children('.module');
            $module.gfV3ProductPrice();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child6').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child6-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child6-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child6-2').children('.module');
            $module.gfV3ProductPrice();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child7').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child7-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child7-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child7-2').children('.module');
            $module.gfV3ProductPrice();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child8').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child8-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child8-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1621276499360-child8-2').children('.module');
            $module.gfV3ProductPrice();
        }); 
...
(function( jQuery ){
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1615484398790-child8').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1615484398790-child8-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1615484398790-child8-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1615484398790-child8-2').children('.module');
            $module.gfV3ProductPrice();
        }); 
