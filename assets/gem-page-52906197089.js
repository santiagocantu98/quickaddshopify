          ...
          jQuery(function() {
  var $hero = jQuery('#m-1595992300944');
  var $module = jQuery('#m-1595992300944').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
   ...
   changeImage();
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597186184179');
  var $module = jQuery('#m-1597186184179').children('.module');
